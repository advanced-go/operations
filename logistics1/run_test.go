...
func ExampleRun() {
	...
	//Output:
	//test: activity1.Log() -> 2024-07-08T17:11:39.367Z : logistics1:west : process assignments : default
	//test: activity1.Log() -> 2024-07-08T17:11:41.373Z : logistics1:west : process assignments : onTick()
