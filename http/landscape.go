...
func landscapeExchange[E core.ErrorHandler](r *http.Request, p *uri.Parsed) (*http.Response, *core.Status) {
	h2 := make(http.Header)
	...
	switch r.Method {
	case http.MethodGet:
		return landscapeGet[E](r.Context(), r.Header, r.URL, p.Version)
	case http.MethodPut:
		return landscapePut[E](r, p.Version)
	default:
...
func landscapeGet[E core.ErrorHandler](ctx context.Context, h http.Header, url *url.URL, version string) (resp *http.Response, status *core.Status) {
	var entries any
	var h2 http.Header

	switch version {
	case module.Ver1, "":
		entries, h2, status = landscape1.Get(ctx, h, url.Query())
	default:
...
func landscapePut[E core.ErrorHandler](r *http.Request, version string) (resp *http.Response, status *core.Status) {
	var h2 http.Header

	switch version {
	case module.Ver1, "":
		h2, status = landscape1.Put(r, nil)
	default:
