...
func ExampleGet() {
	...
	//test: get("assigned-region=west&status=active&traffic=ingress") -> [status:OK] [entries:[{5 us-central1 c  ingress active  2024-06-10 09:00:35 +0000 UTC case-officer1 west} {7 us-central1 d  ingress active  2024-06-10 09:00:35 +0000 UTC case-officer1 west}]]
